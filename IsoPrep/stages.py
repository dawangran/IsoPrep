...
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""stages.py — Sub-steps for the pipeline."""
...
def cutadapt_stage(fq: Path, outdir: Path, tools: ToolPaths, model: AdapterModel, df: Defaults, threads: int,fullength: bool) -> Path:
