...
def main():
    ...
    ap.add_argument("--no-gene", action="store_true", help="propagate to umi_correct_longreads.py")
    ap.add_argument("--fast-h1", action="store_true", help="propagate to umi_correct_longreads.py")
